---
title: Sources
description: Build Rustalink from source and configure credentials for music sources like YouTube, Spotify, Deezer, Tidal, and more.
---

import { Tabs, TabItem, Aside } from "@astrojs/starlight/components";

Build Rustalink from source and learn how to retrieve the tokens and credentials needed for each music source.
